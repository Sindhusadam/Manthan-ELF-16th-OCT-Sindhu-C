...
LOCK TABLES `myfiles` WRITE;
/*!40000 ALTER TABLE `myfiles` DISABLE KEYS */;
INSERT INTO `myfiles` VALUES (1,'Cheliyaa','A','Happy','D:/','best Song'),(2,'Dheeme','mikki','abc','D:/','relaxed'),(4,'Stranger','Elle','Crazy','D:/','Happy');
/*!40000 ALTER TABLE `myfiles` ENABLE KEYS */;
UNLOCK TABLES;
